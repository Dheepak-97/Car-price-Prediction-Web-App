...
X_train,X_test,y_train,y_test = train_test_split(scaledX,y, test_size = 0.33, random_state = 42)
...
result = model_building(algo_list, X_train, y_train, kfold, scoring) # 3:40 pm

cross_val_score = dict(zip(algo_name,result))
